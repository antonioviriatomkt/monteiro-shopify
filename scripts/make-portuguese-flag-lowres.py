...
OUT = Path("data/logo/mosaic/portuguese-flag-lowres.png")
SAMPLE_ROOTS = [
...
# Square coat of arms (5x5 at the green/red boundary).
COA_CX, COA_CY = 6, 5
COA_R = 2
...
def main():
    ...
    canvas.save(OUT)
    print(f"saved {OUT} ({W}x{H})  cells: green={n_green}, red={n_red}, coa={n_coa}")
